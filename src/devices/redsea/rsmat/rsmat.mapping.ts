...
export const config = {
  ...
  state_background_imgs: {
    percent_100: new URL(
      "../../../img/redsea/RSMAT/RSMAT_100_BASE.png",
      import.meta.url,
    ),
    percent_75: new URL(
      "../../../img/redsea/RSMAT/RSMAT_75_BASE.png",
      import.meta.url,
    ),
    percent_50: new URL(
      "../../../img/redsea/RSMAT/RSMAT_50_BASE.png",
      import.meta.url,
    ),
    percent_25: new URL(
      "../../../img/redsea/RSMAT/RSMAT_25_BASE.png",
      import.meta.url,
    ),
    percent_0: new URL(
      "../../../img/redsea/RSMAT/RSMAT_0_BASE.png",
      import.meta.url,
    ),
  },
  css: {
  ...
  elements: {
    ec_sensor: {
      ...
      type: "click-image",
      image: new URL(
        "../../../img/redsea/RSMAT/RSMAT_SENSOR_PLUGGED.png",
        import.meta.url,
      ),
    ...
    ec_sensor_disconnected: {
      ...
      master: true,
      image: new URL(
        "../../../img/redsea/RSMAT/RSMAT_SENSOR_UNPLUGGED.png",
        import.meta.url,
      ),
      css: {
        width: "100%",
