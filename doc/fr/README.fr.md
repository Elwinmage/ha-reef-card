...
> La première version sera publiée dans la bibliothèque standard HACS dans quelques semaines et supportera le ReefDose 4 de Redsea.<br />
> ***Vous pouvez voter pour choisir le prochain appareil supporté [ici](https://github.com/Elwinmage/ha-reef-card/discussions/22).***
