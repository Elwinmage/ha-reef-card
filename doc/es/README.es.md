...
<table>
  ...
  <tr>
    ...
    <td><b>ha-reef-card</b><br /><i>(este repositorio)</i></td>
...
Nivel de agua y depósito, controles de llenado, sonda de fugas, zumbador,
diagnóstico de la bomba y gráfico de consumo, cada uno con su propio diálogo.
