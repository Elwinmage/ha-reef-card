...
| <img src="https://raw.githubusercontent.com/Elwinmage/ha-reef-card/main/icon.png" width="100" alt="ha-reef-card" />                                   | **ha-reef-card**<br />_(questo repository)_                                                     | Vista grafica interattiva di ogni dispositivo sulla tua dashboard, e unico modo per modificare le programmazioni avanzate. Legge le tre integrazioni tramite il contratto `reef_role` comune, senza configurazione lato scheda.                                                                                                                                                                                                                                                                                                                                                                                                                                                               | tutte e tre le integrazioni                |
